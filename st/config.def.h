...
static char font[] = "Source Code Pro-12:antialias=true:autohint=true";
...
static const char *colorname[] = {
	/* 8 normal colors */
	"#282828", /* dark0 - hard contrast: #1d2021 / soft contrast: #32302f */
	"#cc241d", /* neutral_red    */
 ...
 */
static unsigned int defaultfg = 7;    /* light4 */
static unsigned int defaultbg = 0;    /* dark0  */
static unsigned int defaultcs = 256;  /* light3 */
static unsigned int defaultrcs = 257; /* dark3  */
